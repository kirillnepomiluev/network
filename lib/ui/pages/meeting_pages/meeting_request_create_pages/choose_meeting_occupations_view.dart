...
class ChooseMeetingOccupationsView extends StatefulWidget {
  const ChooseMeetingOccupationsView({Key? key,}) : super(key: key);

  @override
  State<ChooseMeetingOccupationsView> createState() => _ChooseMeetingOccupationsViewState();
}

class _ChooseMeetingOccupationsViewState extends State<ChooseMeetingOccupationsView> {
