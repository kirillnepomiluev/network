...
class ChooseMeetingCategoriesView extends StatefulWidget {
  const ChooseMeetingCategoriesView({Key? key,}) : super(key: key);

  @override
  State<ChooseMeetingCategoriesView> createState() => _ChooseMeetingCategoriesViewState();
}

class _ChooseMeetingCategoriesViewState extends State<ChooseMeetingCategoriesView> {
