...
class MeetingInvitationsView extends StatefulWidget {
  const MeetingInvitationsView({Key? key}) : super(key: key);

  @override
  State<MeetingInvitationsView> createState() => _MeetingInvitationsViewState();
}

class _MeetingInvitationsViewState extends State<MeetingInvitationsView> {
  int _activeTab = 1;
