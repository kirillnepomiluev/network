...
import 'package:network_app/ui/pages/home_pages/wallet_main/wallet_main_vm.dart';
import 'package:network_app/ui/pages/home_pages/wallet_main/widgets/currency_screen.dart';
import 'package:network_app/ui/pages/home_pages/wallet_main/widgets/token_screen.dart';
import 'package:network_app/ui/pages/home_pages/wallet_main/widgets/wallet_tab.dart';
...
class WalletMainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<WalletMainViewModel>(
        createModelDataEx: () => WalletMainViewModel(context),
